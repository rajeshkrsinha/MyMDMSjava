...
@Entity()
@Table(name="irwms_wagon_type_mapping_with_fois", schema="mdms_wagon")
public class IRWMS_Wagon_Type_Mapping_With_Fois {
	@Id
	@Column(name="s_no")
	...
	@Column(name="fois_wagon_type")
	private String fois_wagon_type;
	...
	public String getFois_wagon_type() {
		return fois_wagon_type;
	}

	public void setFois_wagon_type(String fois_wagon_type) {
		this.fois_wagon_type = fois_wagon_type;
	}
